...
export class GetAlimtalkTemplateCommand extends SensCommand<
  GetAlimtalkTemplateCommandInput, GetAlimtalkTemplateCommandOutput, SensClientResolvedConfig
> {
  ...
  async serialize(
    input: GetAlimtalkTemplateCommandInput, config: SensClientResolvedConfig
  ): Promise<HttpRequest> {
